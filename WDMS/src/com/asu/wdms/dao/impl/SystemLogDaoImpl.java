...
public class SystemLogDaoImpl extends WdmsDaoImpl implements SystemLogDao {
	...
	private final String systemlog_insert = "INSERT INTO SYSTEMLOG( userName,sessionID,operation,startTime,endTime) VALUES(?,?,?,?,?)";
	...
	public void addLog(SystemLog systemLog) {
		this.getJdbcTemplate().update(this.systemlog_insert, new Object[]{systemLog.getUserName(),systemLog.getSessionId(),systemLog.getOperation(), systemLog.getStartTime(),systemLog.getEndTime()});
